...
import { createStructureDefinition, encode, decode } from "../../../src/protocol";
...
describe("Protocol Core Functionality Tests", () => {
	...
	describe("Debug Information", () => {
		it("should show what encoding produces", () => {
			...
			console.log("Structure shape:", JSON.stringify(struct.shape, null, 2));
			console.log("Encoded packet:", JSON.stringify(packet, null, 2));
		...
		it("should show values extraction", () => {
			...
			console.log("Values array:", JSON.stringify(packet.values, null, 2));
			console.log("Structure:", JSON.stringify(struct.shape, null, 2));
